package com.example.smarttransport.data.remote



import com.example.smarttransport.data.models.MakeOrderResponse
import com.example.smarttransport.data.models.MorePagesDataModel
import com.example.smarttransport.data.models.PageDataModel
import com.example.smarttransport.data.models.ProductDetailsResponse
import com.example.smarttransport.user.data.models.AddressResponse
import com.example.smarttransport.user.data.models.AllStoreResponse
import com.example.smarttransport.user.data.models.CancellationResponse
import com.example.smarttransport.user.data.models.CartDetailsResponse
import com.example.smarttransport.user.data.models.CountriesResponse
import com.example.smarttransport.user.data.models.HomeResponse
import com.example.smarttransport.user.data.models.MoreDataModel
import com.example.smarttransport.user.data.models.MoreResponse
import com.example.smarttransport.user.data.models.NotificationResponse
import com.example.smarttransport.user.data.models.OfferProductsResponse
import com.example.smarttransport.user.data.models.OrderDetailsResponse
import com.example.smarttransport.user.data.models.OrdersListResponse
import com.example.smarttransport.user.data.models.PaymentMethodsResponse
import com.example.smarttransport.user.data.models.ProfileResponse
import com.example.smarttransport.user.data.models.StoreDetailsResponse
import com.example.smarttransport.user.data.models.StoreResponse
import com.example.smarttransport.user.data.models.WalletResponse
import com.example.smarttransport.user.data.remote.DefaultDataModel
import com.example.smarttransport.user.data.remote.DefaultPayment
